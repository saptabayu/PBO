...
# Label Nama
Nama = tk.Label(window, text="JADWAL KULIAH     SAPTA BAYU PERMANA (220511169)", bg='lightblue')

# Membuat label dan entry untuk setiap kolom
label_mata_kuliah = tk.Label(window, text="Mata Kuliah  :", bg='lightblue')
...
label_ruang = tk.Label(window, text="Ruang  :", bg='lightblue')
entry_ruang = tk.Entry(window)

label_gedung = tk.Label(window, text="Gedung    :", bg='lightblue')
gedung_options = ["Ir.H.Djuanda", "Machdor"]
combo_gedung = ttk.Combobox(window, values=gedung_options)

label_hari = tk.Label(window, text="Hari    :", bg='lightblue')
hari_options = ["Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu", "Minggu"]
combo_hari = ttk.Combobox(window, values=hari_options)

label_jam_mulai = tk.Label(window, text="Jam Mulai  :", bg='lightblue')
entry_jam_mulai = tk.Entry(window)

label_jam_selesai = tk.Label(window, text="Jam Selesai  :", bg='lightblue')
entry_jam_selesai = tk.Entry(window)

label_dosen = tk.Label(window, text="Dosen  :", bg='lightblue')
